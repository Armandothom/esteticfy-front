...
import { VendaListService } from './vendalist.service';
...
export class VendaListComponent implements OnInit {
    ...
    displayedColumns = ['valor', 'cliente', 'atendente', 'servico', 'acoes'];
    inputSearch = '';
    ...
    constructor(
        private _vendaListService: VendaListService,
    ...
    refreshLista() {
        ...
        this._vendaListService.getVenda();
        this.dataSource.filter = this.filter.nativeElement.value;
    }

    excluirVenda(id: any) {
        let loadingComponent = this.matDialog.open(LoadingDialogComponent);
        this._vendaService.handleFormRemoveValue(id).then(() => {
            this._vendaListService.getVenda();
        }).finally(() => {
    ...
    ngOnInit(): void {
        this.dataSource = new FilesDataSource(this._vendaListService, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any>
{
     ...
     * Constructor
     *
     * @param {VendaListService} _vendaListService
    ...
    constructor(
        ...
        super();
        this.filteredData = this._vendaListService.vendas;
    }
    ...
    connect(): Observable<any[]> {
        const displayDataChanges = [
            this._vendaListService.onVendasChanged,
        ...
        return merge(...displayDataChanges)
            .pipe(
                map(() => {
                    let data = this._vendaListService.vendas.slice();
